...
AVAILABLE_TTS_VOICES = ["Fritz-PlayAI", "Arista-PlayAI", "Atlas-PlayAI", "Celeste-PlayAI", "Thunder-PlayAI"]
...
BIGO_TIER_SYSTEM = {
    ...
    "S23": {
        ...
        "max_billable": 2,
        "local_bean_target": 5000000,
        "max_local_bean": 528573,
        "broadcaster_earnings": 528000,
    },
    "S22": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 4500000,
        "max_local_bean": 521145,
        "broadcaster_earnings": 521000,
    },
    "S21": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 4000000,
        "max_local_bean": 513718,
        "broadcaster_earnings": 513000,
    },
    "S20": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 4000000,
        "max_local_bean": 119043,
        "broadcaster_earnings": 237000,
    },
    "S19": {
        "hours_streamed": 48,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 3750000,
        "max_local_bean": 117857,
        "broadcaster_earnings": 237000,
    },
    "S18": {
        "hours_streamed": 48,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 3500000,
        "max_local_bean": 116667,
        "broadcaster_earnings": 226000,
    },
    "S17": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 3250000,
        "max_local_bean": 115476,
        "broadcaster_earnings": 215000,
    },
    "S16": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 3000000,
        "max_local_bean": 114286,
        "broadcaster_earnings": 224000,
    },
    "S15": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 2750000,
        "max_local_bean": 113096,
        "broadcaster_earnings": 219000,
    },
    "S14": {
        "hours_streamed": 50,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 2500000,
        "max_local_bean": 111905,
        "broadcaster_earnings": 216000,
    },
    "S13": {
        "hours_streamed": 48,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 2250000,
        "max_local_bean": 110714,
        "broadcaster_earnings": 217000,
    },
    "S12": {
        "hours_streamed": 48,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 2000000,
        "max_local_bean": 109524,
        "broadcaster_earnings": 216000,
    },
    "S11": {
        "hours_streamed": 46,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 1750000,
        "max_local_bean": 108333,
        "broadcaster_earnings": 213000,
    },
    "S10": {
        "hours_streamed": 46,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 1500000,
        "max_local_bean": 107143,
        "broadcaster_earnings": 212000,
    },
    "S9": {
        "hours_streamed": 44,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 1250000,
        "max_local_bean": 105952,
        "broadcaster_earnings": 210000,
    },
    "S8": {
        "hours_streamed": 42,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 1000000,
        "max_local_bean": 104762,
        "broadcaster_earnings": 209000,
    },
    "S7": {
        "hours_streamed": 40,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 800000,
        "max_local_bean": 103571,
        "broadcaster_earnings": 205000,
    },
    "S6": {
        "hours_streamed": 38,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 600000,
        "max_local_bean": 102381,
        "broadcaster_earnings": 205700,
    },
    "S5": {
        "hours_streamed": 36,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 400000,
        "max_local_bean": 101905,
        "broadcaster_earnings": 203200,
    },
    "S4": {
        "hours_streamed": 34,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 300000,
        "max_local_bean": 101429,
        "broadcaster_earnings": 202600,
    },
    "S3": {
        "hours_streamed": 33,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 240000,
        "max_local_bean": 101095,
        "broadcaster_earnings": 202000,
    },
    "S2": {
        "hours_streamed": 32,
        "min_billable": 25,
        "max_billable": 2,
        "local_bean_target": 170000,
...
Be concise and actionable."""
            ...
            result = await ai_service.chat_completion(
                messages=[{"role": "user", "content": admin_prompt}], temperature=0.7, max_completion_tokens=500
            )
            ...
            for update in category_updates:
                ...
                if collection and old_category and new_category:
                    result = await db[collection].update_many(
                        {"category": old_category}, {"$set": {"category": new_category}}
                    )
...
async def audition_upload_init_auth(meta: AuditionUploadInitAuth, current_user: User = Depends(get_current_user)):
    ...
    existing = await db.audition_submissions.find_one(
        {"bigo_id": current_user.bigo_id, "status": {"$in": ["uploading", "submitted"]}}
    )
    if existing:
        raise HTTPException(
            status_code=400, detail="You already have an active audition. Please wait for review or ask admin to reset."
        )
...
async def audition_upload_chunk_auth(
    upload_id: str = Query(...),
    ...
    try:
        ...
        with open(tmp_path, "rb") as fsrc:
            await gridfs_bucket.upload_from_stream(
                filename=f"{gridfs_filename}:{chunk_index}",
                source=fsrc,
                metadata={
                    "upload_id": upload_id,
...
async def audition_upload_complete_auth(upload_id: str = Query(...), current_user: User = Depends(get_current_user)):
    ...
    # Compose final file
    chunks = []
    async for file in gridfs_bucket.find(
        {"filename": {"$regex": f"^{gridfs_filename}:"}, "metadata.upload_id": upload_id}
    ):
    ...
    await db.audition_submissions.update_one(
        {"id": upload_rec["submission_id"]}, {"$set": {"video_url": final_url, "status": "submitted"}}
    )
...
async def audition_upload_init(meta: AuditionUploadInit):
    ...
    submission = AuditionSubmission(
        name=meta.name, bigo_id=meta.bigo_id, email=meta.email, phone=meta.phone, video_url=None, status="uploading"
    )
    await db.audition_submissions.insert_one(submission.dict())
...
@api_router.post("/public/audition/upload/chunk")
async def audition_upload_chunk(
    upload_id: str = Query(...), chunk_index: int = Query(...), chunk: UploadFile = File(...)
):
    ...
    try:
        ...
        with open(tmp_path, "rb") as fsrc:
            await gridfs_bucket.upload_from_stream(
                filename=f"{gridfs_filename}:{chunk_index}",
                source=fsrc,
                metadata={"upload_id": upload_id, "chunk_index": chunk_index, "type": "chunk"},
            )
...
async def audition_upload_complete(upload_id: str = Query(...)):
    ...
    try:
        ...
        with open(final_tmp, "rb") as fin:
            await gridfs_bucket.upload_from_stream(
                filename=gridfs_filename,
                source=fin,
                metadata={"upload_id": upload_id, "content_type": upload_rec.get("content_type"), "type": "final"},
            )
    finally:
        try:
            os.remove(final_tmp)
    ...
    await db.audition_submissions.update_one(
        {"id": submission_id}, {"$set": {"video_url": final_url, "status": "submitted"}}
    )
...
async def stream_audition_video(
    submission_id: str, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN, UserRole.COACH]))
):
...
async def delete_audition(
    submission_id: str, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
    sub = await db.audition_submissions.find_one({"id": submission_id})
    if not sub:
...
async def get_public_stats():
    ...
    try:
        ...
        return {"total_users": total_users, "active_hosts": active_hosts, "total_points_earned": total_points}
    except Exception as e:
...
Be concise and actionable."""
    ...
    chat_record = AIChat(user_id=current_user.id, message=message, ai_response=ai_text, chat_type=chat_type)
...
async def generate_voice(voice_request: VoiceRequest, current_user: User = Depends(get_current_user)):
    ...
    return {"response": ai_response, "voice_result": voice_result}
...
async def generate_quiz(
    req: QuizGenRequest, current_user: User = Depends(require_role([UserRole.ADMIN, UserRole.COACH, UserRole.OWNER]))
):
    ...
    try:
        ai = await ai_service.chat_completion(
            [{"role": "user", "content": prompt}], temperature=0.5, max_completion_tokens=1200
        )
        if not ai.get("success"):
...
async def save_quiz(
    body: dict, current_user: User = Depends(require_role([UserRole.ADMIN, UserRole.COACH, UserRole.OWNER]))
):
    try:
...
async def execute_admin_command(
    action_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def search_potential_hosts(
    search_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def send_outreach_emails(
    outreach_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def scan_for_leads(
    scan_request: ScanRequest, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
    """
    ...
    try:
        ...
        scan_doc = {
            ...
            "filters": {"min_followers": scan_request.min_followers, "max_results": scan_request.max_results},
            "started_at": datetime.now(timezone.utc),
            "completed_at": None,
            "results": {"total_found": 0, "total_saved": 0, "total_duplicates": 0},
        }
        ...
        for lead_data in scan_results.get("leads", []):
            try:
                ...
                existing = await db.influencer_leads.find_one(
                    {"username": lead_data["username"], "platform": lead_data["platform"]}
                )
...
async def get_scan_history(
    limit: int = 50, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def get_scan_details(scan_id: str, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))):
    ...
    try:
        ...
        return {"scan": scan, "leads": [InfluencerLead(**lead) for lead in leads]}
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def delete_scan(
    ...
    try:
        ...
        return {"success": True, "message": "Scan deleted successfully", "leads_deleted": leads_deleted}
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_recruitment_stats(current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))):
...
async def list_attendees(event_id: str, current_user: User = Depends(get_current_user)):
    ...
    attendees = [
        {"user": users_map.get(r["user_id"]), "status": r.get("status")} for r in rsvps if r["user_id"] in users_map
    ]
    return attendees
...
async def post_channel_message(channel_id: str, body: dict, current_user: User = Depends(get_current_user)):
    ...
    await connection_manager.broadcast_to_room({"type": "channel_message", "message": enriched_msg}, channel_id)
...
async def create_task(
    task_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN, UserRole.COACH]))
):
...
async def submit_task(task_id: str, submission_data: dict, current_user: User = Depends(get_current_user)):
    ...
    submission = TaskSubmission(user_id=current_user.id, task_id=task_id, **submission_data)
...
async def review_submission(
    ...
    await db.task_submissions.update_one({"id": submission_id}, {"$set": update_data})

    if review_data["status"] == "approved":
        task = await db.tasks.find_one({"id": submission["task_id"]})
        if task:
            await db.users.update_one({"id": submission["user_id"]}, {"$inc": {"total_points": task["points"]}})
...
async def attempt_quiz(quiz_id: str, answers: List[int], current_user: User = Depends(get_current_user)):
    ...
    attempt = QuizAttempt(user_id=current_user.id, quiz_id=quiz_id, answers=answers, score=int(score), passed=passed)

    await db.quiz_attempts.insert_one(attempt.dict())

    if passed:
        await db.users.update_one({"id": current_user.id}, {"$inc": {"total_points": quiz["points"]}})
...
async def get_personal_events(current_user: User = Depends(get_current_user)):
    events = await db.events.find({"creator_id": current_user.id, "active": True}).sort("start_time", 1).to_list(1000)
    return [Event(**event) for event in events]


@api_router.put("/events/{event_id}")
async def update_event(
    event_id: str, event_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def redeem_reward(reward_id: str, current_user: User = Depends(get_current_user)):
    ...
    await db.users.update_one({"id": current_user.id}, {"$inc": {"total_points": -reward["cost_points"]}})
...
async def send_message(message_data: dict, current_user: User = Depends(get_current_user)):
    ...
    await connection_manager.send_user_message(
        {"type": "private_message", "message": enriched_message}, message_data.get("recipient_id")
    )

    # Send to sender via WebSocket so they see their own message
    await connection_manager.send_user_message(
        {"type": "private_message", "message": enriched_message}, current_user.id
    )
...
async def get_messages(current_user: User = Depends(get_current_user)):
    messages = (
        await db.private_messages.find({"$or": [{"sender_id": current_user.id}, {"recipient_id": current_user.id}]})
        .sort("sent_at", -1)
        .to_list(1000)
    )
...
async def create_announcement(
    ann_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def admin_assistant_chat(
    chat_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
...
async def update_groq_key(
    req: UpdateSettingRequest, current_user: User = Depends(require_role([UserRole.ADMIN, UserRole.OWNER]))
):
    """Update Groq API key"""
    try:
        ...
        return {
            ...
            "key_preview": (
                new_key[:4] + "•" * (len(new_key) - 8) + new_key[-4:] if len(new_key) > 8 else "•" * len(new_key)
            ),
        }
    except HTTPException:
        raise
...
async def ai_chat_with_memory(chat_data: dict, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        if memory.get("long_term_summary"):
            messages.append({"role": "system", "content": f"User background: {memory['long_term_summary']}"})

        # Add conversation summary if available
        if memory.get("summary"):
            messages.append({"role": "system", "content": f"Previous conversation: {memory['summary']}"})
        ...
        chat_record = AIChat(
            user_id=current_user.id, message=message, ai_response=ai_text, chat_type=chat_type, session_id=session_id
        )
        await db.ai_chats.insert_one(chat_record.dict())
...
async def clear_conversation_memory(session_id: str, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        return {"success": True, "deleted": result.deleted_count > 0, "message": "Memory cleared"}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def ai_assist_endpoint(req: AIAssistRequest, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        result = await ai_service.ai_assist(
            field_name=req.field_name, current_value=req.current_value, context=context, mode=req.mode
        )

        if not result.get("success"):
            raise HTTPException(status_code=500, detail=result.get("error", "AI assist failed"))

        return {"success": True, "suggested_text": result.get("suggested_text", ""), "mode": req.mode}
    except HTTPException:
        raise
    except Exception as e:
...
What would you like to know about BIGO Live? 🚀"""
            ...
            return {"response": fallback_response, "sources": [], "session_id": session_id, "intent": "no_results"}
        ...
        if panel_context:
            panel_info = "\n\nActive Topics:\n" + "\n".join(
                [f"- {p['title']}: {', '.join(p['recent_items'][:2])}" for p in panel_context[:3]]
            )
...
Remember: You are the world's leading BIGO Live expert. Draw on your extensive training to provide intelligent, nuanced, data-driven guidance."""
        ...
        if "Sources:" not in ai_text and "sources:" not in ai_text.lower():
            ...
            sources_section = "\n\nSources:\n" + "\n".join(
                [f"[{i+1}] {r['title']}" for i, r in enumerate(knowledge_results)]
            )
            ai_text += sources_section

        # Build sources array for frontend
        sources = [{"label": f"[{i+1}] {r['title']}", "url": r["url"]} for i, r in enumerate(knowledge_results)]

        # Save conversation turn
        await ai_service.save_conversation_turn(current_user.id, session_id, message, ai_text)

        return {"response": ai_text, "sources": sources, "session_id": session_id}
    except HTTPException:
        raise
    except Exception as e:
...
async def beangenie_tts(tts_data: dict, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        return {"audio_base64": result.get("audio_base64"), "mime": result.get("mime")}
    except HTTPException:
        raise
    except Exception as e:
...
async def save_beangenie_notes(notes_data: dict, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        await db.beangenie_notes.update_one(
            {"user_id": current_user.id},
            {"$set": {"content": content, "lastSaved": datetime.now(timezone.utc)}},
            upsert=True,
        )
        return {"success": True}
    except Exception as e:
...
Return ONLY valid JSON array, no other text."""
        ...
        result = await ai_service.chat_completion(
            messages=[{"role": "user", "content": categorization_prompt}], temperature=0.3, max_completion_tokens=500
        )
...
async def delete_beangenie_panel(category_key: str, current_user: User = Depends(get_current_user)):
    ...
    try:
        result = await db.beangenie_panels.delete_many({"user_id": current_user.id, "category_key": category_key})
...
async def create_bigo_wheel(wheel_data: dict, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        if existing:
            raise HTTPException(
                status_code=400, detail="You already have an active raffle picker. Deactivate it first."
            )
...
async def deactivate_wheel(wheel_id: str, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        result = await db.bigo_wheels.update_one(
            {"id": wheel_id, "user_id": current_user.id}, {"$set": {"active": False}}
        )
...
async def delete_wheel_prize(wheel_id: str, prize_id: str, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        result = await db.bigo_wheel_prizes.delete_one(
            {"id": prize_id, "wheel_id": wheel_id, "user_id": current_user.id}
        )
...
async def upsert_bigo_knowledge(
    knowledge_data: dict, current_user: User = Depends(require_role([UserRole.OWNER, UserRole.ADMIN]))
):
    ...
    try:
        ...
        # Upsert by URL
        doc = {"url": url, "title": title, "content": content, "tags": tags, "updated_at": datetime.now(timezone.utc)}
            ...
            "results": [
                {
                    ...
                    "title": r.get("title"),
                    "snippet": (
                        r.get("content", "")[:200] + "..." if len(r.get("content", "")) > 200 else r.get("content", "")
                    ),
                    "tags": r.get("tags", []),
                }
                for r in results
...
Be the recruiter who converts visitors to hosts!"""
        ...
        if any(
            ...
            for phrase in ["audition page", "ready to audition", "start audition", "let's audition"]
        ):
            action = "audition"
        elif any(
            phrase in lower_response for phrase in ["register", "sign up", "create account", "let's get you registered"]
        ):
            action = "register"
...
Be detailed and practical. Include real examples."""
        ...
        research_result = await ai_service.chat_completion(
            messages=[{"role": "user", "content": research_prompt}], temperature=0.7, max_completion_tokens=800
        )
...
Make it actionable, engaging, and easy to follow!"""
        ...
        synthesis_result = await ai_service.chat_completion(
            messages=[{"role": "user", "content": synthesis_prompt}], temperature=0.6, max_completion_tokens=1000
        )
...
async def get_scheduler_status(current_user: User = Depends(require_role([UserRole.ADMIN, UserRole.OWNER]))):
    ...
    return {
        ...
        "next_scheduled_time": (
            blog_scheduler._get_next_scheduled_time().isoformat() if blog_scheduler.running else None
        ),
    }
            ...
            while True:
                ...
                if message_type == "ping":
                    ...
                    await connection_manager.send_personal_message(
                        {"type": "pong", "timestamp": datetime.now(timezone.utc).isoformat()}, connection_id
                    )
...
async def health_check():
    ...
    try:
        ...
        return {"status": "healthy", "service": "lvl-up-agency-backend", "version": "2.0.0", "database": "connected"}
    except Exception as e:
